      ...
      <div className="flex items-start space-x-3 p-4 bg-white rounded-lg border border-gray-200">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            className="mt-2 inline-flex items-center text-sm text-climate-blue-600 hover:text-climate-blue-800 font-medium"
          >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <div className="flex-1 bg-gray-200 rounded-full h-3">
                    <div
                      className="h-3 rounded-full bg-gradient-to-r from-climate-green-500 to-climate-green-600"
                ...
                <p className="text-xs text-gray-500 mt-2">
                  Confidence derived from Perplexity-backed reasoning and cross-checks with reference datasets.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="prose prose-sm max-w-none">
                  <p className="text-gray-700 whitespace-pre-wrap bg-gray-50 p-4 rounded-lg">{justification}</p>
                </div>
              </div>
                    ...
                    {sourceList.slice(0, 5).map((source, idx) => {
                      ...
                      return (
                        <li key={idx} className="flex items-start space-x-2 text-sm">
                          <span className="text-climate-blue-600 font-semibold">{idx + 1}.</span>
                          <a
                            href={source}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-climate-blue-600 hover:underline break-all"
                          >
                            {truncated}
                          </a>
                        </li>
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 space-y-3">
                  ...
                  {externalEvidence.climatecheck && (
                    <div className="text-xs text-gray-600">
                      <span className="font-semibold text-green-700">ClimateCheck:</span>{" "}
                  ...
                  {externalEvidence.nasa && (
                    <div className="text-xs text-gray-600">
                      ...
                      Surface temperature {externalEvidence.nasa.temperature ?? "n/a"} °C ({externalEvidence.nasa.timestamp ?? "timestamp unavailable"})
                    </div>
                  )}
                </div>
              )}
            ...
            <div className="border-t p-4 bg-gray-50 flex justify-end">
              <button
                onClick={() => setShowModal(false)}
                className="px-4 py-2 bg-climate-green-600 text-white rounded-lg hover:bg-climate-green-700 transition-colors"
              >
                Close
              </button>
            </div>

// /privacy — renders docs/compliance/PRIVACY_POLICY.md via the GitHub raw URL,
// so the source of truth stays the markdown file in this repo.
//
// Linked from the signup form's GDPR consent checkbox (was 404 before this).
    ...
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      {err && (
        <div className="rounded border border-red-300 bg-red-50 p-4 text-red-800">
          Failed to load the policy ({err}). View the source at{" "}

...
export default function AnalyzePage() {
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-slate-100 mb-2">Analyze Article URL</h1>
      ...
      <div className="mt-12 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6">
        <h2 className="font-semibold text-gray-900 dark:text-slate-100 mb-3">How it works:</h2>

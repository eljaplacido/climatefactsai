        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 space-y-4">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Primary-source indicators</h3>
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Multi-LLM verification</h3>
                  <p className="text-sm text-blue-800">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Calibrated confidence</h3>
                  <p className="text-sm text-blue-800">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-1">Full provenance</h3>
                  <p className="text-sm text-blue-800">
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <h3 className="font-semibold text-gray-900 mb-2">Public Interest</h3>
                <p className="text-sm text-gray-600">
          ...
          <section className="space-y-4">
            ...
            <p className="text-sm text-gray-600 mt-4">
              ...
              <Link href="/methodology" className="text-clilens-primary underline">Methodology page</Link>.
            </p>
          </section>
          ...
          {/* Contact */}
          <section className="text-center text-sm text-gray-600 border-t pt-6 space-y-1">
            <p>
              Questions, feedback, or methodology suggestions? Reach out at{' '}
              <a href="mailto:hello@climatefacts.ai" className="text-clilens-primary underline">
            ...
            <p>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-clilens-primary underline"
              >
                CISU Regen
              </a>

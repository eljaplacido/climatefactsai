...
_INGESTION_COUNTRIES = os.getenv(
    "INGESTION_COUNTRIES",
    # 80+ countries (2026-06-14, seq-9) — aligned with the runtime default
    # in ingestion.py:scheduled_multi_country_ingestion. Override per-deploy
    # via INGESTION_COUNTRIES env var to add or remove regions.
    "US,GB,CA,AU,NZ,JP,KR,IN,CN,FI,SE,NO,DK,DE,FR,NL,BE,CH,AT,PL,ES,PT,IT,GR,IE,"
    "BR,MX,AR,CL,CO,PE,ZA,NG,KE,EG,MA,ET,GH,SN,AE,SA,IL,TR,RU,UA,KZ,UZ,"
    "ID,VN,TH,PH,MY,SG,PK,BD,LK,RO,BG,CZ,HU,SK,SI,HR,EE,LV,LT,MT,CY,IS,LU,"
    "EC,UY,CR,PA,GT,DO,BO,VE,DZ,TN,NP,MM,KH"
).split(",")
